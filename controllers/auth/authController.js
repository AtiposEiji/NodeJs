...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if(!freshUser){
        return next(new AppError("There token belonging to this user does no longer exist", 401));
    }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    const message = `Forgot your password? Submit a PATCH request with yourn new password and passwordConfirm to: ${resetURL}.`
